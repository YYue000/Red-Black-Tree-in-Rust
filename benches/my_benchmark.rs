...
fn bench_search_test_avl(mut tree:AVLTree<i32>,tree_size:i32) {
    for i in 0..tree_size {
        tree.delete(i);
    }
}
...
fn bench_search_test_rbt(mut tree:RedBlackTree<i32>,tree_size:i32) {
...
//criterion_group!(benches, avl_benchmark_insert, rbt_benchmark_insert);
