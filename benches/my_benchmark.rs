...
fn rbt_benchmark_insert(c: &mut Criterion) {
    ...
    c.bench_function("rbt_insert_benchmark", |b| b.iter(|| bench_insert_test_avl(black_box(array),array_index)));
}
...
criterion_group!(benches, avl_benchmark_insert,avl_benchmark_search, rbt_benchmark_search, rbt_benchmark_insert);
